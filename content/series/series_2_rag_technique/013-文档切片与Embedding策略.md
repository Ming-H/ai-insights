---
title: "文档切片与Embedding策略"
date: 2026-01-09
draft: false
tags: ['文档切片', 'Chunking', 'Embedding', '语义切片', '文本分割', '向量表示', '检索质量']
categories: ["series_2_rag_technique", "实践"]
description: "RAG系统的两大基石：如何科学地切分文档（固定大小、语义切片、滑动窗口），如何选择和优化Embedding模型（OpenAI、Cohere、BGE等），以及这些选择如何影响检索质量。"
