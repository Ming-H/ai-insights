...
date: 2026-04-05
draft: false
tags: ['量化', 'INT8', 'QAT', 'PTQ', '模型压缩', '边缘部署', '量化感知训练']
categories: ["ml_series_7_model_optimization", "进阶"]
description: "量化原理：INT8/INT4量化、量化感知训练。GEMM低比特优化、量化误差累积。Post-Training Quantization (PTQ)、Quantization-Aware Training (QAT)。在边缘设备、移动端部署中的应用。"
series: "ml_series_7_model_optimization"
episode: 61
difficulty: "进阶"
