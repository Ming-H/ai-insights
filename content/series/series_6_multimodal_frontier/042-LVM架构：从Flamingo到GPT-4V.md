---
title: "LVM架构：从Flamingo到GPT-4V"
date: 2026-01-09
draft: false
tags: ['LVM', 'GPT-4V', 'Flamingo', 'BLIP', 'Gemini Vision', '视觉语言模型', '多模态架构', '跨模态融合']
categories: ["series_6_multimodal_frontier", "前沿"]
description: "视觉语言模型架构演进：从Flamingo、BLIP到GPT-4V、Gemini Pro Vision的架构分析，对比不同的视觉编码器和跨模态融合策略，以及多模态模型的最新进展。"
