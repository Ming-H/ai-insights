...
date: 2026-01-28
draft: false
tags: ['协同过滤', '矩阵分解', 'SVD', 'ALS', '隐语义', 'Netflix Prize']
categories: ["ml_series_6_recommender_systems", "进阶"]
description: "用户-物品矩阵的稀疏性挑战。User-based、Item-based CF。矩阵分解：SVD、SVD++、ALS。隐语义模型，以及在Netflix Prize、电商推荐中的应用。"
series: "ml_series_6_recommender_systems"
episode: 52
difficulty: "进阶"
