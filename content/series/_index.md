...
<div class="series-block series-block--va">
  ...
  <p class="series-block-desc">语音技术全栈指南，40 期从 ASR 到端到端语音大模型，从 NLU 到全栈开发实战。40 篇已发布。</p>
  <div class="series-card-grid">
    <a href="va_series_1_speech_fundamentals/" class="series-card">
      <div class="series-card-num">01</div>
      <div class="series-card-title">语音技术基础</div>
      <div class="series-card-tags">ASR · TTS · VAD · 音频编解码 · 声纹 · 降噪</div>
    </a>
    <a href="va_series_2_speech_llm/" class="series-card">
      <div class="series-card-num">02</div>
      <div class="series-card-title">语音大模型</div>
      <div class="series-card-tags">端到端 · SpeechLM · GPT-4o · 全双工 · 延迟优化</div>
    </a>
    <a href="va_series_3_dialogue_nlu/" class="series-card">
      <div class="series-card-num">03</div>
      <div class="series-card-title">对话系统与 NLU</div>
      <div class="series-card-tags">意图识别 · 对话管理 · 话轮转换 · 情感识别</div>
    </a>
    <a href="va_series_4_development/" class="series-card">
      <div class="series-card-num">04</div>
      <div class="series-card-title">开发实战</div>
      <div class="series-card-tags">全栈架构 · Pipecat · RAG · 流式全链路 · 边缘部署</div>
    </a>
    <a href="va_series_5_applications/" class="series-card">
      <div class="series-card-num">05</div>
      <div class="series-card-title">行业应用与前沿</div>
      <div class="series-card-tags">车载 · 医疗 · 智能家居 · 安全隐私 · UX 设计</div>
    </a>
  </div>
</div>
