...
date: 2026-01-28
draft: false
tags: ['推荐系统', '召回', '排序', '重排', 'AUC', 'NDCG', 'A/B测试']
categories: ["ml_series_6_recommender_systems", "入门"]
description: "推荐系统的核心价值。召回、排序、重排三层架构。离线评估（AUC、NDCG、MAP）与在线评估（CTR、CVR、GMV）。A/B测试、用户调研。"
