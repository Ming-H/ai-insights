...
description: "ImageNet数据集解析。数据增强策略（RandAugment、AutoAugment、MixUp、CutMix）。训练ResNet、EfficientNet、Vision Transformer，达到SOTA性能的完整pipeline。"
series: "ml_series_3_computer_vision"
episode: 22
difficulty: "实践"
