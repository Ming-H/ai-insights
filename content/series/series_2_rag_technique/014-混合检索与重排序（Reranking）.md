---
title: "混合检索与重排序（Reranking）"
date: 2026-01-09
draft: false
tags: ['混合检索', 'Hybrid Search', 'BM25', '重排序', 'Reranking', 'Cross-encoder', '检索优化']
categories: ["series_2_rag_technique", "进阶"]
description: "提升RAG准确率的关键技术：结合关键词检索（BM25）和向量检索的混合检索策略，使用Cross-encoder等重排序模型优化检索结果，以及如何平衡准确性和效率。"
