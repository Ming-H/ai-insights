...
date: 2026-01-12
draft: false
tags: ['提示安全', 'Prompt Injection', '越狱', 'Jailbreak', '安全防护', '输入验证', '对抗性提示']
categories: ["series_4_prompt_engineering", "进阶"]
description: "提示安全攻防战：提示注入（Prompt Injection）的原理与危害、越狱攻击的常见手法，以及如何设计防御性提示、输入验证、输出过滤来保护系统安全。"
series: "series_4_prompt_engineering"
episode: 30
difficulty: "进阶"
