...
date: 2026-01-09
draft: false
tags: ['GraphRAG', '知识图谱', 'Knowledge Graph', '图检索', '结构化数据', '实体关系', 'Community Detection']
categories: ["series_2_rag_technique", "进阶"]
description: "知识图谱与RAG的结合：GraphRAG如何利用实体关系和图结构提升检索质量、Community Detection算法、图谱构建流程，以及在结构化知识场景中的优势。"
