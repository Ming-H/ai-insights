...
date: 2026-01-30
draft: false
tags: ['AutoML', '自动化机器学习', 'AutoSklearn', 'AutoGluon', 'H2O', '超参数优化']
categories: ["ml_series_7_model_optimization", "前沿"]
description: "AutoML全流程：数据预处理、特征工程、模型选择、超参数优化。AutoSklearn、AutoGluon、H2O.ai。神经架构搜索NAS，以及在低门槛AI建模中的应用。"
