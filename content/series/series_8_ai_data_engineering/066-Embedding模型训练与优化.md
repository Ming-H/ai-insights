---
title: "Embedding模型训练与优化"
date: 2026-01-09
draft: false
tags: ['Embedding训练', '对比学习', 'SimCSE', '领域自适应', '模型蒸馏', '向量表示']
categories: ["series_8_ai_data_engineering", "进阶"]
description: "定制化Embedding模型：Embedding训练原理（对比学习、SimCSE）、领域自适应训练、多语言Embedding、Embedding评估指标、模型蒸馏与压缩，以及如何为特定场景训练专属Embedding模型。"
series: "series_8_ai_data_engineering"
episode: 66
difficulty: "进阶"
