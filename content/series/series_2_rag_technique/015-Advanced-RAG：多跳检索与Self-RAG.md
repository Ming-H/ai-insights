---
title: "Advanced RAG：多跳检索与Self-RAG"
date: 2026-01-09
draft: false
tags: ['Advanced RAG', '多跳检索', 'Multi-hop Retrieval', 'Self-RAG', '递归检索', '复杂推理']
categories: ["series_2_rag_technique", "进阶"]
description: "进阶RAG技术：处理复杂推理问题的多跳检索（Multi-hop Retrieval）、自反思检索（Self-RAG）、递归检索与迭代优化，以及如何让AI自主判断何时需要检索。"
